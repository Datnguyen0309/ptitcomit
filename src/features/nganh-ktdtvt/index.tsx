      ...
      <Box margin={"0 auto"} minH={"214px"} bg={"#F8F9FA"}>
        <Container maxW={"1728px"}>
          <Breadcrumb padding={"16px 0px"} color={"#00338d "} fontWeight={"bold"}>
            ...
            <BreadcrumbItem>
              <BreadcrumbLink as={Link} href={"/nganh-dao-tao"}>Ngành đào tạo </BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbItem>
              <BreadcrumbLink href='/nganh-ky-thuat-dien-tu-vien-thong' color={"#000 !important"}>Kỹ thuật điện tử viễn thông </BreadcrumbLink>
            </BreadcrumbItem>
          </Breadcrumb>
          <HeadSection
            subtitle="Kỹ thuật điện tử viễn thông " />
        </Container>
      </Box>
      <InputMajordtvt />
      <RouterNganh />
